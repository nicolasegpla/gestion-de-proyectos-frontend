...
export const Register = () => {
    ...
    function handleChangeRegisterEmpresa(event) {
    ...
    const registrarEmpresa = async (empresa) => {
        try {
    ...
    function handleChangeRegisterUsuario(event) {
        const { name, value } = event.target;
    ...
    return (_jsx(_Fragment, { children: _jsxs(CenterLayout, { children: [TypeRegister === 'none' && (_jsxs(TemplateCenter, { children: [_jsx("h1", { children: "Seleccionar tipo de registro" }), _jsxs(TemplateCenter, { children: [_jsx(Button, { textButton: "Registrar Empresa", onClick: () => setTypeRegister('empresa') }), _jsx(Button, { textButton: "Registrar Usuario", onClick: () => setTypeRegister('usuario') }), _jsx("p", { className: "link", onClick: goToLogin, children: "Login" })] })] })), TypeRegister === 'empresa' && (_jsxs(TemplateCenter, { children: [_jsx("h1", { children: "Registrar Empresa" }), _jsx(FormRegisterEmpresa, { buttonProps: { textButton: 'Registrar empresa', onClick: handleSubmit }, inputsFieldData: dataInputsField })] })), TypeRegister === 'usuario' && (_jsxs(TemplateCenter, { children: [_jsx("h1", { children: "Registrar Usuario" }), _jsx(TemplateCenter, { children: _jsx(FormRegisterEmpresa, { buttonProps: {
                                    textButton: 'Registrar usuario',
                                    onClick: handleSubmitRegisterUser,
                                }, inputsFieldData: inputuserdata, isSelectRequired: true, selectValue: RegisterUsuario.empresa_id, selectName: "empresa_id", onSelectChange: (e) => setRegisterUsuario({
                                    ...RegisterUsuario,
